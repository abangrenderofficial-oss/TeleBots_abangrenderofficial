...
async function refineInitialPreview({ itemId, chatId, caption, fileName, resolved, draft }) {
  ...
  // Known translation formats need AI. New formats do not spend an AI call
  // until the owner has confirmed their rules.
  const shouldUseAi = Boolean(resolved.profile?.actions?.translate);
