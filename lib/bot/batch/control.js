...
export async function resumeLatest({ chatId, query = null, res }) {
  ...
  // The inline RESUME button belongs to SEND control only. It must never
  // bypass an unfamiliar-format review. The /resume command owns the safe
  // sequence: confirm format -> drain caption queue -> resume SEND.
