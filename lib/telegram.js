import { telegramWebhookSecret } from './bot/core/telegram-webhook-auth.js';
import { getQueueItem, getQueueItemBySourceMessage, getSetting, setSetting } from './store.js';

const STABLE_WEBHOOK_URL = 'https://tele-bots-abangrenderofficial.vercel.app/api/telegram-safe-destination';
...
export async function telegram(method, payload = {}) {
  ...
  // Webhook registration is intentionally NOT performed here. Normal bot
  // operations must never be able to change routing. Only repair/setup code owns
  // setWebhook now.
